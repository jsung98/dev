...
namespace Eguana\WorkBoard\Block;
...
class View extends Template
{
    ...
    public function getBoardCollection()
    {
        ...
        try {
            ...
            $collection->addFieldToFilter('main_active', ['eq' => '1']);
           // $collection->addAttributeToSort('position', 'desc');
            //$collection->addFieldToFilter('creation_time', ['lteq' => $this->date->gmtDate()]);
    ...
    {
        return $this->boardConfiguration->getConfigValue('per_page_board_main');
    }
