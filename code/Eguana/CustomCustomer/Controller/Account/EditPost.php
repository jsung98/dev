 ...
 */
class EditPost extends \Magento\Customer\Controller\Account\EditPost implements CsrfAwareActionInterface, HttpPostActionInterface
{
    /**
     ...
     * @param CustomerSubscriberCache $customerSubscriberCache
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            try {
                ...
                $subscribeStatus = $this->getRequest()->getPost('is_subscribed');

                if ($extensionAttributes->getIsSubscribed() !== $subscribeStatus) {
                    $storeId = $this->storeManager->getStore()->getId();
                    $customerId = (int)$customer->getId();
                    $subscriber = $subscribeStatus
                        ? $this->subscriptionManager->subscribeCustomer($customerId, (int)$storeId)
                        : $this->subscriptionManager->unsubscribeCustomer($customerId, (int)$storeId);
